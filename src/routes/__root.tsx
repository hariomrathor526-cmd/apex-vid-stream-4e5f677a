...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AURA MAX Player" },
      { name: "description", content: "Stream lectures via AURA MAX Powered by AURA MAX" },
      { property: "og:title", content: "AURA MAX Player" },
      { property: "og:description", content: "Stream lectures via AURA MAX Powered by AURA MAX" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AURA MAX Player" },
